					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							...
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/高雄-1/type2-高雄1.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/高雄-1/type2-高雄1(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/高雄-1/type2-高雄1(2).jpg');"></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type2_K1">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type2_K1" style="display:none"></iframe>
							</form>
							<div class="card">
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										...
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type4-kaohsiung-1.php"
													class="btn-custom">Room Detail<span
														class="icon-long-arrow-right"></span></a></p>
										</div>
									</div>
