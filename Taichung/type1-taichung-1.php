...
<body>
	...
	<div class="hero-wrap" style="background-image: url('../image/台中-1/type1-台中1(main).jpg');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
				<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
					<div class="text">
						<h1 class="mb-4 bread">我們有故事旅店</h1>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							...
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type1-台中1.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type1-台中1(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type1-台中1(2).jpg');"></div>
								</div>
							</div>
						</div>
						<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
							<div class="d-md-flex mt-5 mb-5">
								<ul class="list">
									...
									<li><span>房間面積:</span> 21 m2</li>
								</ul>
								<ul class="list ml-md-5">
									<li><span>床型:</span> 1張雙人床</li>
								</ul>
							</div>
							<h2>Device</h2>
							<div class="content">
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							...
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type1_C1">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type1_C1" style="display:none"></iframe>
							</form>
							<div class="card">
						...
						<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
							...
							<div class="row">
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/台中-1/Ttype2-台中1.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/台中-1/type2-台中1.jpg);">
										...
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type2-taichung-1.php" class="btn-custom">Room Detail
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/台中-1/Ttype4-台中1.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/台中-1/type4-台中1.jpg);">
											<div class="icon d-flex justify-content-center align-items-center">
												<span class="icon-search2"></span>
											</div>
										</a>
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="../Taichung/type4-taichung-1.php" class="btn-custom">Room
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">台中市西屯區福星路228號</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-phone"></span><span class="text">04-2452 8920</span></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-envelope"></span><span
										class="text">ourshotel@gmail.com</span></li>
							</ul>
						</div>
					</div>
				</div>
