					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							...
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type2-台中1.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type2-台中1(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-1/type2-台中1(2).jpg');"></div>
								</div>
							</div>
						</div>
						<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
							<div class="d-md-flex mt-5 mb-5">
								<ul class="list">
									...
									<li><span>房間面積:</span> 23 m2</li>
								</ul>
								<ul class="list ml-md-5">
									<li><span>床型:</span> 1 張加大雙人床</li>
								</ul>
							</div>
							<h2>Device</h2>
							<div class="content">
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type2_C1">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type2_C1" style="display:none"></iframe>
							</form>
							<div class="card">
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										...
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type4-taichung-1.php"
													class="btn-custom">Room Detail<span
														class="icon-long-arrow-right"></span></a></p>
										</div>
									</div>
