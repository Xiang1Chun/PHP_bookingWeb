...
session_start();
require '../conn.php';
$_SESSION['hotel'] = "台中市中區三民路二段149巷8-1號2樓";
$_SESSION['room'] = "四人房";
...
<body>
	...
	<div class="hero-wrap" style="background-image: url('../image/台中-2/type1-台中2(main).jpg');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
				<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
					<div class="text">
						<h1 class="mb-4 bread">呆一中</h1>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							...
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-2/type4-台中2.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-2/type4-台中2(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/台中-2/type4-台中2(2).jpg');"></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type4_C2">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type4_C2" style="display:none"></iframe>
							</form>
							<div class="card">
						...
						<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
							...
							<div class="row">
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/台中-2/Ttype1-台中2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/台中-2/type1-台中2.jpg);">
										...
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type1-taichung-2.php"
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href=".../image/台中-2/Ttype2-台中2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/台中-2/type2-台中2.jpg);">
											<div class="icon d-flex justify-content-center align-items-center">
												<span class="icon-search2"></span>
											</div>
										</a>
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type2-taichung-2.php"
													class="btn-custom">Room Detail<span
														class="icon-long-arrow-right"></span></a></p>
										</div>
									</div>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">台中市中區三民路二段149巷8-1號2樓</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-phone"></span><span class="text"></span></li>
							</ul>
						</div>
					</div>
				</div>
