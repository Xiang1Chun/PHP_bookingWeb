...
<body>
	...
	<div class="hero-wrap" style="background-image: url('../image/taipei-2/type-taipei2(main).jpg');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
				<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
					<div class="text">
						<h1 class="mb-4 bread">福格大飯店</h1>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-8">
					<div class="row">
						<div class="col-md-12 ftco-animate">
							<h2 class="mb-4">四人房</h2>
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/taipei-2/type4-taipei2.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/taipei-2/type4-taipei2(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/taipei-2/type4-taipei2(2).jpg');"></div>
								</div>
							</div>
						</div>
						<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
							<div class="d-md-flex mt-5 mb-5">
								<ul class="list">
									<li><span>最多人數:</span> 4 Persons</li>
									<li><span>房間面積:</span> 30 m2</li>
								</ul>
								<ul class="list ml-md-5">
									<li><span>床型:</span> 2 張加大雙人床</li>
								</ul>
							</div>
							<h2>Device</h2>
							<div class="content">
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type4_N2">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type4_N2" style="display:none"></iframe>
							</form>
							<div class="card">
						...
						<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
							...
							<div class="row">
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/taipei-2/Ttype1-taipei2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/taipei-2/type1-taipei2.jpg);">
										...
										<div class="text p-3 text-center">
											...
											<p><span class="price mr-2">$
													<?php $_SESSION['room'] = "單人房";
														require '../price.php';
													?>
												</span> <span class="per"><?php echo "$_SESSION[day]" ?> night</span>
											</p>
											<hr>
											<p class="pt-1"><a href="../Taipei/type1-taipei-2.php"
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/taipei-2/Ttype2-taipei2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/taipei-2/type2-taipei2.jpg);">
											<div class="icon d-flex justify-content-center align-items-center">
												<span class="icon-search2"></span>
											</div>
										</a>
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="../Taipei/type2-taipei-2.php"
													class="btn-custom">Room Detail<span
														class="icon-long-arrow-right"></span></a></p>
										</div>
									</div>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">新北市淡水區學府路89號</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-phone"></span><span class="text">02-2626 2929</span></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-envelope"></span><span
										class="text">rvd_03@regalees-hotel.com.tw</span></li>
							</ul>
						</div>
					</div>
				</div>
