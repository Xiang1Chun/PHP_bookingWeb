...
<body>
	...
	<div class="hero-wrap" style="background-image: url('../image/桃園-2/type1-桃園2(main).jpg');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
				<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
					<div class="text">
						<h1 class="mb-4 bread">191商務旅店</h1>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							...
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/桃園-2/type1-桃園2.jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/桃園-2/type1-桃園2(1).jpg');"></div>
								</div>
								<div class="item">
									<div class="room-img"
										style="background-image: url('../image/桃園-2/type1-桃園2(2).jpg');"></div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 properties-single ftco-animate mb-5 mt-4">
							...
							<form method="POST" action="../evaluation.php" style="margin-bottom: 15%;" target = "type1_U1">
								<h4 class="mb-4">評分</h4>
								...
								<input type="submit" value="送出" class="btn float-right"
									...
									<iframe name="type1_U1" style="display:none"></iframe>
							</form>
							<div class="card">
						...
						<div class="col-md-12 room-single ftco-animate mb-5 mt-5">
							...
							<div class="row">
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/桃園-2/Ttype2-桃園2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/桃園-2/type2-桃園2.jpg);">
										...
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type2-taoyuan-2.php" class="btn-custom">Room Detail
								...
								<div class="col-sm col-md-6 ftco-animate">
									<div class="room">
										<a href="../image/桃園-2/Ttype4-桃園2.jpg"
											class="img img-2 d-flex justify-content-center align-items-center"
											style="background-image: url(../image/桃園-2/type4-桃園2.jpg);">
											<div class="icon d-flex justify-content-center align-items-center">
												<span class="icon-search2"></span>
											</div>
										</a>
										<div class="text p-3 text-center">
											...
											<hr>
											<p class="pt-1"><a href="type4-taoyuan-2.php" class="btn-custom">Room
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">桃園市桃園區中華路12號5樓</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-phone"></span><span class="text">03-3336 767</span></li>
							</ul>
						</div>
					</div>
				</div>
